...
public class ApiUserController {
    ...
    public ResponseEntity<List<User>> getUserNotVerified() {
        return new ResponseEntity<>(this.userService.getUserNotVerified(), HttpStatus.OK);
    }

    @PatchMapping("/users/{userId}/is-verified")
    @CrossOrigin
    public ResponseEntity<?> updateIsVerified(@PathVariable(value = "userId") int id) {
        if (this.userService.updateIsVerified(id)) {
